...
func buildChangeEmailOTPMailBody(name, otp string) string {
	return fmt.Sprintf(`
    <!DOCTYPE html>
    <html>
    <body style="margin:0;padding:0;background:#f5f5f5;font-family:'DM Sans',Arial,sans-serif;">
            ...
            <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e0e0e0;">
              ...
              <tr>
                <td style="padding:16px 36px 40px;">
                  ...
                  <p style="font-size:18px;color:#555555;line-height:1.7;margin:0 0 32px;">
                    We received a request to update the email address associated with your MyVault account. Use the code below to verify your account.
                  </p>
...
func buildChangeEmailAlertMailBody(name, newEmail, time string) string {
	return fmt.Sprintf(`
    <!DOCTYPE html>
    <html>
    <body style="margin:0;padding:0;background:#f5f5f5;font-family:'DM Sans',Arial,sans-serif;">
            ...
            <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e0e0e0;">
              ...
              <tr>
                <td style="padding:16px 36px 40px;">
                  ...
                  <p style="font-size:18px;color:#555555;line-height:1.7;margin:0 0 32px;">
                    Your MyVault account email address has been successfully updated.
                  </p>

                  <!-- Info Card -->
                  <div style="background:#f0f7ff;border:1px solid #cfe8ff;padding:20px 24px;margin-bottom:24px;">
                    <p style="font-size:12px;color:#1e88e5;margin:0 0 6px;text-transform:uppercase;letter-spacing:1px;">Updated Email</p>
                    <p style="font-size:17px;font-weight:600;color:#333333;margin:0;">%s</p>
                  </div>
                  ...
                  <div style="background:#fff8f8;border:1px solid #fde0e0;padding:20px 24px;margin-bottom:32px;">
                    <p style="font-size:12px;color:#e57373;margin:0 0 6px;text-transform:uppercase;letter-spacing:1px;">Not you?</p>
                    <p style="font-size:15px;color:#333333;line-height:1.7;margin:0;">
                      If you did not make this change, your account may be compromised. Please reset your password immediately or contact our support team.
                    </p>
                  </div>

                  <p style="font-size:14px;color:#999999;line-height:1.7;margin:0;">
                    This change was made on %s.
                  </p>
...
func buildChangedPasswordAlertMailBody(name, time string) string {
	return fmt.Sprintf(`
    <!DOCTYPE html>
    <html>
    <body style="margin:0;padding:0;background:#f5f5f5;font-family:'DM Sans',Arial,sans-serif;">
            ...
            <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border:1px solid #e0e0e0;">
              ...
              <tr>
                <td style="padding:16px 36px 40px;">
                  ...
                  <p style="font-size:18px;color:#555555;line-height:1.7;margin:0 0 32px;">
                    Your MyVault account password has been successfully changed. If this was you, you can safely ignore this message.
                  </p>
                  <p style="font-size:18px;color:#555555;line-height:1.7;margin:0 0 32px;">
                    Password was changed at %s.
                  </p>
